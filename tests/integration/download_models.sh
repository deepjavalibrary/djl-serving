...
python_skl_models_urls=(
  ...
  "https://resources.djl.ai/test-models/python/sklearn/sklearn_custom_model_sm.zip"
  "https://resources.djl.ai/test-models/python/sklearn/sklearn_custom_model_input_output.zip"
  "https://resources.djl.ai/test-models/python/sklearn/sklearn_custom_model_input_output_invalid.zip"
  "https://resources.djl.ai/test-models/python/sklearn/sklearn_mixed_djl_sagemaker.zip"
  "https://resources.djl.ai/test-models/python/sklearn/sklearn_djl_all_formatters_v3.zip"
...
python_xgb_models_urls=(
  ...
  "https://resources.djl.ai/test-models/python/xgboost/xgboost_mixed_djl_sagemaker.zip"
  "https://resources.djl.ai/test-models/python/xgboost/xgboost_djl_all_formatters_v3.zip"
