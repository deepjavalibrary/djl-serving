        ...
        <el-row :gutter="20">
          ...
          <el-col :span="8">
            <el-form-item label="model_version:" prop="model_version">
              <template slot="label">
                <el-tooltip class="item" effect="dark" content="the version of the mode" placement="top"><span>model_version:</span></el-tooltip>
              </template>
            ...
            <el-row :gutter="20">
              <el-col :span="8">
                <el-form-item label="batch_size:" prop="batch_size">
                  <template slot="label">
                    <el-tooltip class="item" effect="dark" content="the inference batch size. The default value is `1`." placement="top"><span>batch_size:</span></el-tooltip>
                  </template>
              ...
              <el-col :span="8">
                <el-form-item label="max_idle_time:" v-if="form.batch_size>1" prop="max_idle_time">
                  <template slot="label">
                    <el-tooltip class="item" effect="dark" content=" the maximum idle time before the worker thread is scaled down." placement="top"><span>max_idle_time:</span></el-tooltip>
                  </template>
