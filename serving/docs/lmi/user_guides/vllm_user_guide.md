...
| option.generation_config                | >= 0.32.0   | LMI                | Set to 'auto' to use the generation parameters from the model's `generation_config.json`. Any generation parameters in the request payload take priority over the generation parameters from this config                                                                                                                                                                     | Possible values: 'auto', None. Default: None |
